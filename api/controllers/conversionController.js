...
var conversionController = function () {
    var convertV1 = function (rawDataString) {
        return __awaiter(this, void 0, void 0, function () {
            var rawSplitData, foundZero, i;
            return __generator(this, function (_a) {
                ...
                if (rawDataString === '') {
                    ...
                    rawSplitData = [];
                    foundZero = false;
                    for (i = 0; i < rawDataString.length; i++) {
    ...
    var convertV2 = function (rawDataString) {
        return __awaiter(this, void 0, void 0, function () {
            var splitData;
            return __generator(this, function (_a) {
                ...
                if (rawDataString === '') {
                    ...
                    splitData = rawDataString.split('0').filter(function (x) { return x !== ''; });
                    return [2 /*return*/, {
